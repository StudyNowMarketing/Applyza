...
const posts = [
  {
    ...
    excerpt:
      "Choosing a university is one of the biggest decisions you'll make. Here's a practical framework to narrow down your options and find the perfect fit.",
  },
  {
    category: "Visa Guide",
    title: "UK Student Visa 2026: Everything You Need to Know",
    excerpt:
      "From documents to timelines, here's your complete guide to the UK student visa process — including recent policy updates for 2026.",
  },
  {
    category: "Budgeting",
    title:
      "Studying Abroad on a Budget: 5 Countries Where Education Won't Break the Bank",
    excerpt:
      "You don't need a fortune to get a world-class education. These five destinations offer quality programmes at surprisingly affordable costs.",
  },
];
