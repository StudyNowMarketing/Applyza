                ...
                filtered.map((r) => (
                  <>
                    <tr key={r.id} className="border-b hover:bg-muted/30 cursor-pointer" onClick={() => setExpanded(expanded === r.id ? null : r.id)}>
                      ...
                      <td className="px-4 py-3 text-muted-foreground">{r.user_type || "—"}</td>
                    ...
                    {expanded === r.id && (
                      <tr key={`${r.id}-detail`} className="bg-muted/20">
                        <td colSpan={6} className="px-8 py-4">
                          ...
                          <p className="text-sm text-muted-foreground mt-2"><span className="font-medium text-primary">Message:</span> {r.message}</p>
                        </td>
                      </tr>
                    )}
                  </>
